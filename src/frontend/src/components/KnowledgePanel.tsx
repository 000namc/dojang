...
export default function KnowledgePanel() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Tags */}
      {currentCard.tags && (
        <div className="flex items-center gap-1.5 px-4 py-2 border-b dark:border-gray-700">
          <Tag size={12} className="text-gray-400" />
          {currentCard.tags.split(",").map((tag, i) => (
            <span
              key={i}
              className="rounded-full bg-primary-50 dark:bg-primary-900/30 px-2.5 py-0.5 text-xs font-medium text-primary-700 dark:text-primary-300"
            >
              {tag.trim()}
            </span>
          ))}
      ...
      {/* Footer */}
      <div className="border-t dark:border-gray-700 px-4 py-2 text-xs text-gray-400">
...
function CardEditor({
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Tags */}
      <div className="flex items-center gap-2 border-b dark:border-gray-700 px-4 py-2">
